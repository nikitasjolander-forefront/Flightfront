...
public class ParsedMetar
{
    ...
    public List<Weather> Weather { get; init; } = new(); //Lista av objekt, eller objekt med lista med string?
    public List<Clouds> Clouds { get; init; } = new(); //Lista av objekt, eller objekt med lista med string?
